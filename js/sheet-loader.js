...
function importConfigurazione(workbook, bilancio) {
    ...
    try {
        ...
        // Col 2 = fine (seriale Excel), Col 3 = inizio, Col 7 = anno
        const fineCorrenteSerial = getCellValue(sheet, 8, 2);
        const inizioCorrenteSerial = getCellValue(sheet, 8, 3);
        const annoCorrente = getCellValue(sheet, 8, 7);
        
        // Riga 9: Date esercizio precedente
        const finePrecedenteSerial = getCellValue(sheet, 9, 2);
        const inizioPrecedenteSerial = getCellValue(sheet, 9, 3);
