...
function salvaConfigurazione() {
    ...
    const annoCorrente = parseInt(document.getElementById('config_anno_corrente').value);
    const annoPrecedente = parseInt(document.getElementById('config_anno_precedente').value);
    const codiceFiscale = document.getElementById('config_codice_fiscale').value.trim();
    const valuta = document.getElementById('config_valuta').value;
